...
table_df["Relative Change"] = (table_df["Absolute Change"]/table_df["2000"])
...
emissions_long = emissions.melt(id_vars="country", var_name="year", value_name="emissions").sort_values(["country","year"])
...
emissions_long_subset = emissions_long_1990_2022.query("country == ['Germany', 'Poland', 'Netherlands', 'France', 'Austria']")

# Create line chart. Year should be on the x-axis, emissions on the y-axis, and color should be by country.
fig_chart = px.line(emissions_long_subset, x="year", 
             y= "emissions", 
             color="country",
             markers=True,
             labels = {"year": "Year",
                       "emissions": "Emissions",
                       "country": "Country"},
             title = "CO_2 emissions across selected European countries from 1990 to 2022."          
             )
fig_chart.update_xaxes(showgrid=False)
fig_chart.update_yaxes(showgrid=False)
fig_chart 
```
